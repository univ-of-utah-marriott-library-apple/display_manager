...
/usr/bin/python -m PyInstaller --windowed --onefile ../../gui.py  # create app
./setIcon.py icon.icns dist/gui.app
cd ..  # go back to script-level dir
mkdir -p ROOT/Applications
mv app/dist/gui.app "ROOT/Applications/Display Manager.app"
